...
mydata$Spooky = mydata$FL_32_DO_Enigmaticframe + mydata$FL_32_DO_enigmaticframeexpl + mydata$FL_32_DO_enigmaticbenefit + mydata$FL_32_DO_enigmaticrisk + mydata$FL_32_DO_enigmaticbalanced + mydata$FL_32_DO_enigmaticexplbenef + mydata$FL_32_DO_Enigmaticexplrisk + mydata$FL_32_DO_Enigmaticexplanationbalanced
mydata$Explanation = mydata$FL_32_DO_Explquantumconcept + mydata$FL_32_DO_enigmaticframeexpl + mydata$FL_32_DO_explanationbenefit + mydata$FL_32_DO_explanationrisk + mydata$FL_32_DO_explanationbalanced + mydata$FL_32_DO_enigmaticexplbenef + mydata$FL_32_DO_Enigmaticexplrisk + mydata$FL_32_DO_Enigmaticexplanationbalanced
mydata$Benefit = mydata$FL_32_DO_benefitframe + mydata$FL_32_DO_enigmaticbenefit + mydata$FL_32_DO_explanationbenefit + mydata$FL_32_DO_enigmaticexplbenef
mydata$Risk = mydata$FL_32_DO_riskframe + mydata$FL_32_DO_enigmaticrisk + mydata$FL_32_DO_explanationrisk + mydata$FL_32_DO_Enigmaticexplrisk
mydata$Both = mydata$FL_32_DO_balancedframe + mydata$FL_32_DO_enigmaticbalanced + mydata$FL_32_DO_explanationbalanced + mydata$FL_32_DO_Enigmaticexplanationbalanced

table(mydata$Spooky)
frames = mydata|>
  select(Token, age_cont,sex_rec, edu_clean, weight_trimmed_0.980, Spooky:Both)
